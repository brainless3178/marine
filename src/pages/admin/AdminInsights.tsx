...
import { SectionHeader } from '../../components/admin/insights/SectionHeader'
import { InsightsTableOfContents, SECTIONS } from '../../components/admin/insights/InsightsTableOfContents'
import { Loader2, Layers, ChevronsUpDown } from 'lucide-react'
    ...
    <div className="space-y-6 relative">
      ...
      {showTOC && (
        <div className="fixed bottom-20 right-6 z-50 w-72 animate-in slide-in-from-bottom-4 duration-200">
          <InsightsTableOfContents onClose={() => setShowTOC(false)} />
        </div>
      )}
