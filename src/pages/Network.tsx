  ...
  return (
    <div>
      <SEO
        ...
        canonical="/network"
      />
      <section className="py-20 bg-secondary-bg text-center relative overflow-hidden">
      ...
      <section className="py-16">
        <div className="max-w-[1280px] mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-12 items-start">
            {/* Globe */}
            <div className="h-[300px] sm:h-[500px] bg-secondary-bg border border-[var(--border)] overflow-hidden">
            ...
            {/* Region list */}
            <div className="bg-secondary-bg border border-[var(--border)] p-6 max-h-[500px] overflow-y-auto">
              <h3 className="text-sm font-semibold mb-4">{t('network.regionsCapabilities')}</h3>
              <div className="space-y-2">
                {regions.map((r) => (
                  <div key={r.country} className="p-3 bg-surface border border-[var(--border)] transition-all hover:border-accent-blue">
