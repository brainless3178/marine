...
export function Button({
  ...
  const variants = {
    primary:
      'bg-[var(--brick-ember)] text-[var(--honeydew)] border-[var(--brick-ember)] hover:bg-[#9a2509] hover:border-[#9a2509] hover:-translate-y-0.5 rounded-full',
    outline:
    ...
    danger:
      'bg-danger text-[var(--text-primary)] border-danger hover:bg-red-600 hover:border-red-600 hover:-translate-y-0.5',
    ghost:
