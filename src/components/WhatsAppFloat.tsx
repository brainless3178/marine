...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-[100] flex items-center gap-0 rounded-full bg-[#25D366] text-white shadow-[0_4px_20px_rgba(37,211,102,0.35)] transition-all duration-300 hover:gap-3 hover:pr-5 hover:shadow-xl hover:shadow-[#25D366]/25 animate-[whatsappFloatIn_0.5s_ease-out_both]"
    >
