...
export const products: Product[] = [
  // MARINE EQUIPMENT
  enrichProduct({ id: 'prod-001', filename: 'product-001_electrical.jpg', name: 'Marine GPS Navigator', brand: 'ABB', sku: 'GPS-NAV-3200', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-002', filename: 'product-002_electrical.jpg', name: 'Deck Crane Hydraulic Motor', brand: 'Parker', sku: 'DCM-450-PK', category: 'marine', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-003', filename: 'product-003_electrical.jpg', name: 'VHF Marine Radio', brand: 'Siemens', sku: 'VHF-7800-SM', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-004', filename: 'product-004_electrical.jpg', name: 'Radar Antenna Unit', brand: 'Honeywell', sku: 'RAD-ANT-220', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-005', filename: 'product-005_electrical.jpg', name: 'ECDIS Navigation Display', brand: 'ABB', sku: 'ECDIS-9600', category: 'marine', industry: ['marine-shipping'], availability: 'emergency', specs: {} }),
  enrichProduct({ id: 'prod-006', filename: 'product-006_electrical.jpg', name: 'Marine Diesel Engine Sensor', brand: 'Bosch Rexroth', sku: 'MDS-SENS-44', category: 'marine', industry: ['marine-shipping', 'power-generation'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-007', filename: 'product-007_electrical.jpg', name: 'Lifeboat Release Mechanism', brand: 'Siemens', sku: 'LRM-2200-SM', category: 'marine', industry: ['marine-shipping'], availability: 'emergency', specs: {} }),
  enrichProduct({ id: 'prod-008', filename: 'product-008_electrical.jpg', name: 'Anchor Windlass Motor', brand: 'ABB', sku: 'AWM-550-AB', category: 'marine', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-009', filename: 'product-009_electrical.jpg', name: 'Bilge Water Separator', brand: 'Danfoss', sku: 'BWS-150-DF', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-010', filename: 'product-010_electrical.jpg', name: 'Marine Exhaust Gas Monitor', brand: 'Emerson', sku: 'MEGM-880', category: 'marine', industry: ['marine-shipping', 'oil-gas'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-011', filename: 'product-011_electrical.jpg', name: 'Bow Thruster Control Panel', brand: 'Schneider Electric', sku: 'BTP-3200-SE', category: 'marine', industry: ['marine-shipping'], availability: 'emergency', specs: {} }),
  enrichProduct({ id: 'prod-012', filename: 'product-012_electrical.jpg', name: 'Marine Fire Detection System', brand: 'Honeywell', sku: 'MFD-9000', category: 'marine', industry: ['marine-shipping', 'oil-gas'], availability: 'emergency', specs: {} }),
  enrichProduct({ id: 'prod-013', filename: 'product-013_hydraulic.jpg', name: 'Hatch Cover Hydraulic Cylinder', brand: 'Parker', sku: 'HHC-600-PK', category: 'marine', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-014', filename: 'product-014_hydraulic.jpg', name: 'Marine Ballast Pump', brand: 'Grundfos', sku: 'MBP-250-GF', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-015', filename: 'product-015_hydraulic.jpg', name: 'Steering Gear Actuator', brand: 'Bosch Rexroth', sku: 'SGA-400-BR', category: 'marine', industry: ['marine-shipping'], availability: 'emergency', specs: {} }),
  enrichProduct({ id: 'prod-016', filename: 'product-016_hydraulic.jpg', name: 'Marine Alarm Monitoring System', brand: 'ABB', sku: 'AMS-7700', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-017', filename: 'product-017_hydraulic.jpg', name: 'Deck Floodlight LED', brand: 'Schneider Electric', sku: 'DFL-LED-300', category: 'marine', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-018', filename: 'product-018_hydraulic.jpg', name: 'Marine Air Compressor', brand: 'Atlas Copco', sku: 'MAC-500-AC', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-019', filename: 'product-019_hydraulic.jpg', name: 'Ship Bell Alarm System', brand: 'Siemens', sku: 'SBAS-100-SM', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-020', filename: 'product-020_hydraulic.jpg', name: 'Marine Fuel Purifier', brand: 'Alfa Laval', sku: 'MFP-400-AL', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-021', filename: 'product-021_hydraulic.jpg', name: 'Life Jacket Light', brand: 'ABB', sku: 'LJL-LED-10', category: 'marine', industry: ['marine-shipping'], availability: 'emergency', specs: {} }),
  enrichProduct({ id: 'prod-022', filename: 'product-022_lifting-handling.jpg', name: 'Marine Propeller Shaft Seal', brand: 'Bosch Rexroth', sku: 'MPSS-200-BR', category: 'marine', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-023', filename: 'product-023_lifting-handling.jpg', name: 'Gyro Compass Unit', brand: 'Kongsberg', sku: 'GCU-6000', category: 'marine', industry: ['marine-shipping'], availability: 'emergency', specs: {} }),
  enrichProduct({ id: 'prod-024', filename: 'product-024_lifting-handling.jpg', name: 'Marine Seawater Pump', brand: 'Grundfos', sku: 'MSP-350-GF', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-025', filename: 'product-025_lifting-handling.jpg', name: 'Deck Crane Limit Switch', brand: 'Honeywell', sku: 'DCLS-55-HW', category: 'marine', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-026', filename: 'product-026_lifting-handling.jpg', name: 'Marine Intercom System', brand: 'Siemens', sku: 'MIS-200-SM', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-027', filename: 'product-027_lifting-handling.jpg', name: 'Cargo Hold Ventilation Fan', brand: 'ABB', sku: 'CHVF-400-AB', category: 'marine', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-028', filename: 'product-028_lifting-handling.jpg', name: 'Marine Sewage Treatment Unit', brand: 'Wärtsilä', sku: 'MSTU-100-WT', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-029', filename: 'product-029_lifting-handling.jpg', name: 'Bridge Wing Console', brand: 'Kongsberg', sku: 'BWC-5000', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-030', filename: 'product-030_lifting-handling.jpg', name: 'Marine Oil Water Separator', brand: 'Alfa Laval', sku: 'MOWS-300-AL', category: 'marine', industry: ['marine-shipping', 'oil-gas'], availability: 'emergency', specs: {} }),

  // ELECTRICAL AUTOMATION
  enrichProduct({ id: 'prod-031', filename: 'product-031_equipments-tools.jpg', name: 'Variable Speed Drive 2.2kW', brand: 'ABB', sku: 'ACS880-01-02A7', category: 'electrical', industry: ['manufacturing', 'power-generation'], availability: 'emergency', specs: {} }),
  enrichProduct({ id: 'prod-032', filename: 'product-032_equipments-tools.jpg', name: 'PLC CPU Module S7-1500', brand: 'Siemens', sku: '6ES7511-1AK02', category: 'electrical', industry: ['manufacturing'], availability: 'emergency', specs: {} }),
  enrichProduct({ id: 'prod-033', filename: 'product-033_equipments-tools.jpg', name: 'Contactor 40A 3-Pole', brand: 'Schneider Electric', sku: 'LC1D40M7C', category: 'electrical', industry: ['manufacturing', 'power-generation'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-034', filename: 'product-034_equipments-tools.jpg', name: 'Circuit Breaker MCCB 250A', brand: 'Schneider Electric', sku: 'NSX250F', category: 'electrical', industry: ['power-generation', 'manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-035', filename: 'product-035_equipments-tools.jpg', name: 'Frequency Inverter 7.5kW', brand: 'Siemens', sku: '6SL3224-0BE17', category: 'electrical', industry: ['manufacturing'], availability: 'emergency', specs: {} }),
  enrichProduct({ id: 'prod-036', filename: 'product-036_equipments-tools.jpg', name: 'Motor Protection Relay', brand: 'ABB', sku: 'EF66-100-1SBL', category: 'electrical', industry: ['power-generation'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-037', filename: 'product-037_equipments-tools.jpg', name: 'Soft Starter 45kW', brand: 'ABB', sku: 'PSTX470-600-70', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-038', filename: 'product-038_equipments-tools.jpg', name: 'Power Factor Controller', brand: 'Schneider Electric', sku: 'VarSet-200', category: 'electrical', industry: ['power-generation'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-039', filename: 'product-039_equipments-tools.jpg', name: 'Industrial HMI Panel 15 inch', brand: 'Siemens', sku: 'TP1500-Comfort', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-040', filename: 'product-040_equipments-tools.jpg', name: 'Temperature Controller PID', brand: 'Honeywell', sku: 'DC1040-PT100', category: 'electrical', industry: ['chemical-processing', 'manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-041', filename: 'product-041_equipments-tools.jpg', name: 'Modular PLC I/O Module', brand: 'Siemens', sku: '6ES7131-6BH00', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-042', filename: 'product-042_equipments-tools.jpg', name: 'DIN Rail Power Supply 24V', brand: 'Phoenix Contact', sku: 'QUINT4-PS', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-043', filename: 'product-043_electrical.jpg', name: 'Industrial Ethernet Switch', brand: 'Siemens', sku: 'SCALANCE-XC206', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-044', filename: 'product-044_electrical.jpg', name: 'Contactron Motor Starter', brand: 'Phoenix Contact', sku: 'EFFICIENT-250', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-045', filename: 'product-045_electrical.jpg', name: 'Servo Drive Unit 3kW', brand: 'Bosch Rexroth', sku: 'SEV-3000-BR', category: 'electrical', industry: ['manufacturing'], availability: 'emergency', specs: {} }),
  enrichProduct({ id: 'prod-046', filename: 'product-046_electrical.jpg', name: 'Molded Case Circuit Breaker', brand: 'ABB', sku: 'Tmax-XT2-250', category: 'electrical', industry: ['power-generation'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-047', filename: 'product-047_electrical.jpg', name: 'Digital Power Meter', brand: 'Schneider Electric', sku: 'PM8000-series', category: 'electrical', industry: ['power-generation'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-048', filename: 'product-048_electrical.jpg', name: 'Variable Frequency Drive 15kW', brand: 'Danfoss', sku: 'FC-102P1K5T4', category: 'electrical', industry: ['manufacturing'], availability: 'emergency', specs: {} }),
  enrichProduct({ id: 'prod-049', filename: 'product-049_electrical.jpg', name: 'Safety Relay Module', brand: 'Pilz', sku: 'PNOZ-X3-24VDC', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-050', filename: 'product-050_electrical.jpg', name: 'Panel Mount Ammeter', brand: 'Honeywell', sku: 'DAK-6000-AMP', category: 'electrical', industry: ['power-generation'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-051', filename: 'product-051_electrical.jpg', name: 'Industrial Relay Module 8CH', brand: 'Omron', sku: 'G2R-1-SN-24VDC', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-052', filename: 'product-052_electrical.jpg', name: 'Thermal Overload Relay', brand: 'Schneider Electric', sku: 'LRD3363C', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-053', filename: 'product-053_electrical.jpg', name: 'AC Drive Module 55kW', brand: 'Siemens', sku: 'G120C-PM250', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-054', filename: 'product-054_electrical.jpg', name: 'Smart MCC Panel Section', brand: 'ABB', sku: 'MNS-iS-4000', category: 'electrical', industry: ['manufacturing', 'power-generation'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-055', filename: 'product-055_electrical.jpg', name: 'Surge Protection Device Type2', brand: 'Phoenix Contact', sku: 'VALVETRAB-275', category: 'electrical', industry: ['power-generation'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-056', filename: 'product-056_electrical.jpg', name: 'Industrial UPS 3kVA', brand: 'Emerson', sku: 'APC-SMT3000', category: 'electrical', industry: ['manufacturing', 'power-generation'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-057', filename: 'product-057_electrical.jpg', name: 'Motor Soft Starter 132kW', brand: 'Siemens', sku: '3RT2036-2AK60', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-058', filename: 'product-058_safety.jpg', name: 'Capacitor Bank 50kVAR', brand: 'ABB', sku: 'CLMD-50-AB', category: 'electrical', industry: ['power-generation'], availability: 'in-stock', specs: {} }),

  // HYDRAULIC SYSTEMS
  enrichProduct({ id: 'prod-059', filename: 'product-059_safety.jpg', name: 'Axial Piston Pump 75cc', brand: 'Bosch Rexroth', sku: 'A10VSO-71-DFR1', category: 'hydraulic', industry: ['marine-shipping', 'oil-gas'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-060', filename: 'product-060_safety.jpg', name: 'Hydraulic Cylinder 100mm Bore', brand: 'Parker', sku: 'HCR-100-500-PK', category: 'hydraulic', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-061', filename: 'product-061_safety.jpg', name: 'Directional Control Valve', brand: 'Bosch Rexroth', sku: '4WE6-E70-31', category: 'hydraulic', industry: ['manufacturing', 'oil-gas'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-062', filename: 'product-062_safety.jpg', name: 'Hydraulic Power Unit 15kW', brand: 'Parker', sku: 'HPU-15000-PK', category: 'hydraulic', industry: ['oil-gas', 'marine-shipping'], availability: 'emergency', specs: {} }),
  enrichProduct({ id: 'prod-063', filename: 'product-063_safety.jpg', name: 'Gear Pump 40cc', brand: 'Bosch Rexroth', sku: 'CBN-F3040', category: 'hydraulic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-064', filename: 'product-064_safety.jpg', name: 'Hydraulic Filter Element 10um', brand: 'Parker', sku: 'HC9600FKS13H', category: 'hydraulic', industry: ['oil-gas'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-065', filename: 'product-065_safety.jpg', name: 'Proportional Pressure Valve', brand: 'Bosch Rexroth', sku: 'DBE-6X-G24', category: 'hydraulic', industry: ['oil-gas'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-066', filename: 'product-066_safety.jpg', name: 'Hydraulic Accumulator 4L', brand: 'Parker', sku: 'PRM-4000-PK', category: 'hydraulic', industry: ['marine-shipping'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-067', filename: 'product-067_safety.jpg', name: 'Vane Pump 25cc', brand: 'Parker', sku: 'T6DC-028-010', category: 'hydraulic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-068', filename: 'product-068_safety.jpg', name: 'Counterbalance Valve', brand: 'Bosch Rexroth', sku: 'DZ10DP2-5X', category: 'hydraulic', industry: ['oil-gas'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-069', filename: 'product-069_safety.jpg', name: 'Hydraulic Hose Assembly 1m', brand: 'Parker', sku: '2SN-25-1000', category: 'hydraulic', industry: ['shipyards'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-070', filename: 'product-070_safety.jpg', name: 'Flow Control Valve', brand: 'Bosch Rexroth', sku: '2FRM-16-31', category: 'hydraulic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-071', filename: 'product-071_safety.jpg', name: 'Hydraulic Motor 500cc/rev', brand: 'Danfoss', sku: 'OMR-500-DF', category: 'hydraulic', industry: ['marine-shipping'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-072', filename: 'product-072_safety.jpg', name: 'Pressure Relief Valve 250bar', brand: 'Parker', sku: 'DBDS-6-P1/315', category: 'hydraulic', industry: ['oil-gas'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-073', filename: 'product-073_safety.jpg', name: 'Hydraulic Tank 200L', brand: 'Bosch Rexroth', sku: 'TK-200-BR', category: 'hydraulic', industry: ['shipyards'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-074', filename: 'product-074_safety.jpg', name: 'Hydraulic Manifold Block 6-Port', brand: 'Parker', sku: 'HMB-06-PK', category: 'hydraulic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-075', filename: 'product-075_safety.jpg', name: 'Check Valve Pilot Operated', brand: 'Bosch Rexroth', sku: 'SL10PA2-5X', category: 'hydraulic', industry: ['oil-gas'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-076', filename: 'product-076_safety.jpg', name: 'Hydraulic Cartridge Valve', brand: 'Parker', sku: 'CD08-30-PK', category: 'hydraulic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-077', filename: 'product-077_safety.jpg', name: 'Solenoid Valve 24VDC 3/2', brand: 'Bosch Rexroth', sku: '4WE5-C6X', category: 'hydraulic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-078', filename: 'product-078_safety.jpg', name: 'Hydraulic Quick Coupling Set', brand: 'Parker', sku: 'Palmprint-60', category: 'hydraulic', industry: ['shipyards'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-079', filename: 'product-079_safety.jpg', name: 'Radial Piston Pump 100cc', brand: 'Bosch Rexroth', sku: 'RP100-BR-31', category: 'hydraulic', industry: ['oil-gas'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-080', filename: 'product-080_safety.jpg', name: 'Hydraulic Oil Cooler 5kW', brand: 'Danfoss', sku: 'SK1-055-KK', category: 'hydraulic', industry: ['power-generation'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-081', filename: 'product-081_safety.jpg', name: 'Proportional Flow Valve', brand: 'Bosch Rexroth', sku: '4WRPE-6-CB2', category: 'hydraulic', industry: ['oil-gas'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-082', filename: 'product-082_safety.jpg', name: 'Hydraulic Test Gauge 400bar', brand: 'Parker', sku: 'TG-400-PK', category: 'hydraulic', industry: ['shipyards'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-083', filename: 'product-083_hydraulic.jpg', name: 'Hydraulic Power Pack 5.5kW', brand: 'Parker', sku: 'HPU-5500-PK', category: 'hydraulic', industry: ['marine-shipping'], availability: 'emergency', specs: {} }),

  // PNEUMATIC SYSTEMS
  enrichProduct({ id: 'prod-084', filename: 'product-084_hydraulic.jpg', name: 'Pneumatic Cylinder ISO 15552', brand: 'Festo', sku: 'DSBC-63-200-PPVA', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-085', filename: 'product-085_hydraulic.jpg', name: 'Air Solenoid Valve 5/2', brand: 'SMC', sku: 'VFA5220-03', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-086', filename: 'product-086_hydraulic.jpg', name: 'FRL Unit with Gauge', brand: 'Festo', sku: 'MSB6-1Z', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-087', filename: 'product-087_hydraulic.jpg', name: 'Pneumatic Gripper Parallel', brand: 'SMC', sku: 'MHZ2-20D', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-088', filename: 'product-088_hydraulic.jpg', name: 'Air Dryer Regenerative', brand: 'Atlas Copco', sku: 'FD-410', category: 'pneumatic', industry: ['manufacturing', 'chemical-processing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-089', filename: 'product-089_hydraulic.jpg', name: 'Pneumatic Rotary Actuator', brand: 'Festo', sku: 'DRQD-25-90', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-090', filename: 'product-090_hydraulic.jpg', name: 'Quick Exhaust Valve', brand: 'SMC', sku: 'AQ2000-02', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-091', filename: 'product-091_hydraulic.jpg', name: 'Pneumatic Air Gun', brand: 'Festo', sku: 'MGP-40-AR', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-092', filename: 'product-092_hydraulic.jpg', name: 'Air Preparation Unit Mini', brand: 'SMC', sku: 'AC30-03-A', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-093', filename: 'product-093_hydraulic.jpg', name: 'Pneumatic Tubing 8mm Blue', brand: 'SMC', sku: 'TUB-8-BLU', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-094', filename: 'product-094_electrical.jpg', name: 'Flow Sensor Pneumatic', brand: 'Festo', sku: 'SFAB-10-10-1SA', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-095', filename: 'product-095_electrical.jpg', name: 'Vacuum Generator Multi Stage', brand: 'SMC', sku: 'ZU10-06-60', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-096', filename: 'product-096_electrical.jpg', name: 'Pneumatic Silencer Muffler', brand: 'SMC', sku: 'AN20-02-A', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-097', filename: 'product-097_electrical.jpg', name: 'Rodless Cylinder Guided', brand: 'Festo', sku: 'MFY-30-250', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-098', filename: 'product-098_electrical.jpg', name: 'Pneumatic Push-In Fitting Set', brand: 'SMC', sku: 'KQ2L-08-06A', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-099', filename: 'product-099_electrical.jpg', name: 'Air Receiver Tank 100L', brand: 'Atlas Copco', sku: 'ART-100-AC', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
  enrichProduct({ id: 'prod-100', filename: 'product-100_electrical.jpg', name: 'Pneumatic Timer Valve', brand: 'Festo', sku: 'VHEF-MS-L-1/8', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} }),
