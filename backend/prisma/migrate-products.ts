...
const rawProducts: StaticProduct[] = [
  // MARINE EQUIPMENT (30)
  { id: 'prod-001', filename: 'product-001.jpg', name: 'Marine GPS Navigator', brand: 'ABB', sku: 'GPS-NAV-3200', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} },
  { id: 'prod-002', filename: 'product-002.jpg', name: 'Deck Crane Hydraulic Motor', brand: 'Parker', sku: 'DCM-450-PK', category: 'marine', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', specs: {} },
  { id: 'prod-003', filename: 'product-003.jpg', name: 'VHF Marine Radio', brand: 'Siemens', sku: 'VHF-7800-SM', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} },
  { id: 'prod-004', filename: 'product-004.jpg', name: 'Radar Antenna Unit', brand: 'Honeywell', sku: 'RAD-ANT-220', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} },
  { id: 'prod-005', filename: 'product-005.jpg', name: 'ECDIS Navigation Display', brand: 'ABB', sku: 'ECDIS-9600', category: 'marine', industry: ['marine-shipping'], availability: 'emergency', specs: {} },
  { id: 'prod-006', filename: 'product-006.jpg', name: 'Marine Diesel Engine Sensor', brand: 'Bosch Rexroth', sku: 'MDS-SENS-44', category: 'marine', industry: ['marine-shipping', 'power-generation'], availability: 'in-stock', specs: {} },
  { id: 'prod-007', filename: 'product-007.jpg', name: 'Lifeboat Release Mechanism', brand: 'Siemens', sku: 'LRM-2200-SM', category: 'marine', industry: ['marine-shipping'], availability: 'emergency', specs: {} },
  { id: 'prod-008', filename: 'product-008.jpg', name: 'Anchor Windlass Motor', brand: 'ABB', sku: 'AWM-550-AB', category: 'marine', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', specs: {} },
  { id: 'prod-009', filename: 'product-009.jpg', name: 'Bilge Water Separator', brand: 'Danfoss', sku: 'BWS-150-DF', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} },
  { id: 'prod-010', filename: 'product-010.jpg', name: 'Marine Exhaust Gas Monitor', brand: 'Emerson', sku: 'MEGM-880', category: 'marine', industry: ['marine-shipping', 'oil-gas'], availability: 'in-stock', specs: {} },
  { id: 'prod-011', filename: 'product-011.jpg', name: 'Bow Thruster Control Panel', brand: 'Schneider Electric', sku: 'BTP-3200-SE', category: 'marine', industry: ['marine-shipping'], availability: 'emergency', specs: {} },
  { id: 'prod-012', filename: 'product-012.jpg', name: 'Marine Fire Detection System', brand: 'Honeywell', sku: 'MFD-9000', category: 'marine', industry: ['marine-shipping', 'oil-gas'], availability: 'emergency', specs: {} },
  { id: 'prod-013', filename: 'product-013.jpg', name: 'Hatch Cover Hydraulic Cylinder', brand: 'Parker', sku: 'HHC-600-PK', category: 'marine', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', specs: {} },
  { id: 'prod-014', filename: 'product-014.jpg', name: 'Marine Ballast Pump', brand: 'Grundfos', sku: 'MBP-250-GF', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} },
  { id: 'prod-015', filename: 'product-015.jpg', name: 'Steering Gear Actuator', brand: 'Bosch Rexroth', sku: 'SGA-400-BR', category: 'marine', industry: ['marine-shipping'], availability: 'emergency', specs: {} },
  { id: 'prod-016', filename: 'product-016.jpg', name: 'Marine Alarm Monitoring System', brand: 'ABB', sku: 'AMS-7700', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} },
  { id: 'prod-017', filename: 'product-017.jpg', name: 'Deck Floodlight LED', brand: 'Schneider Electric', sku: 'DFL-LED-300', category: 'marine', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', specs: {} },
  { id: 'prod-018', filename: 'product-018.jpg', name: 'Marine Air Compressor', brand: 'Atlas Copco', sku: 'MAC-500-AC', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} },
  { id: 'prod-019', filename: 'product-019.jpg', name: 'Ship Bell Alarm System', brand: 'Siemens', sku: 'SBAS-100-SM', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} },
  { id: 'prod-020', filename: 'product-020.jpg', name: 'Marine Fuel Purifier', brand: 'Alfa Laval', sku: 'MFP-400-AL', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} },
  { id: 'prod-021', filename: 'product-021.jpg', name: 'Life Jacket Light', brand: 'ABB', sku: 'LJL-LED-10', category: 'marine', industry: ['marine-shipping'], availability: 'emergency', specs: {} },
  { id: 'prod-022', filename: 'product-022.jpg', name: 'Marine Propeller Shaft Seal', brand: 'Bosch Rexroth', sku: 'MPSS-200-BR', category: 'marine', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', specs: {} },
  { id: 'prod-023', filename: 'product-023.jpg', name: 'Gyro Compass Unit', brand: 'Kongsberg', sku: 'GCU-6000', category: 'marine', industry: ['marine-shipping'], availability: 'emergency', specs: {} },
  { id: 'prod-024', filename: 'product-024.jpg', name: 'Marine Seawater Pump', brand: 'Grundfos', sku: 'MSP-350-GF', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} },
  { id: 'prod-025', filename: 'product-025.jpg', name: 'Deck Crane Limit Switch', brand: 'Honeywell', sku: 'DCLS-55-HW', category: 'marine', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', specs: {} },
  { id: 'prod-026', filename: 'product-026.jpg', name: 'Marine Intercom System', brand: 'Siemens', sku: 'MIS-200-SM', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} },
  { id: 'prod-027', filename: 'product-027.jpg', name: 'Cargo Hold Ventilation Fan', brand: 'ABB', sku: 'CHVF-400-AB', category: 'marine', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', specs: {} },
  { id: 'prod-028', filename: 'product-028.jpg', name: 'Marine Sewage Treatment Unit', brand: 'Wärtsilä', sku: 'MSTU-100-WT', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} },
  { id: 'prod-029', filename: 'product-029.jpg', name: 'Bridge Wing Console', brand: 'Kongsberg', sku: 'BWC-5000', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', specs: {} },
  { id: 'prod-030', filename: 'product-030.jpg', name: 'Marine Oil Water Separator', brand: 'Alfa Laval', sku: 'MOWS-300-AL', category: 'marine', industry: ['marine-shipping', 'oil-gas'], availability: 'emergency', specs: {} },

  // ELECTRICAL AUTOMATION (28)
  { id: 'prod-031', filename: 'product-031.jpg', name: 'Variable Speed Drive 2.2kW', brand: 'ABB', sku: 'ACS880-01-02A7', category: 'electrical', industry: ['manufacturing', 'power-generation'], availability: 'emergency', specs: {} },
  { id: 'prod-032', filename: 'product-032.jpg', name: 'PLC CPU Module S7-1500', brand: 'Siemens', sku: '6ES7511-1AK02', category: 'electrical', industry: ['manufacturing'], availability: 'emergency', specs: {} },
  { id: 'prod-033', filename: 'product-033.jpg', name: 'Contactor 40A 3-Pole', brand: 'Schneider Electric', sku: 'LC1D40M7C', category: 'electrical', industry: ['manufacturing', 'power-generation'], availability: 'in-stock', specs: {} },
  { id: 'prod-034', filename: 'product-034.jpg', name: 'Circuit Breaker MCCB 250A', brand: 'Schneider Electric', sku: 'NSX250F', category: 'electrical', industry: ['power-generation', 'manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-035', filename: 'product-035.jpg', name: 'Frequency Inverter 7.5kW', brand: 'Siemens', sku: '6SL3224-0BE17', category: 'electrical', industry: ['manufacturing'], availability: 'emergency', specs: {} },
  { id: 'prod-036', filename: 'product-036.jpg', name: 'Motor Protection Relay', brand: 'ABB', sku: 'EF66-100-1SBL', category: 'electrical', industry: ['power-generation'], availability: 'in-stock', specs: {} },
  { id: 'prod-037', filename: 'product-037.jpg', name: 'Soft Starter 45kW', brand: 'ABB', sku: 'PSTX470-600-70', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-038', filename: 'product-038.jpg', name: 'Power Factor Controller', brand: 'Schneider Electric', sku: 'VarSet-200', category: 'electrical', industry: ['power-generation'], availability: 'in-stock', specs: {} },
  { id: 'prod-039', filename: 'product-039.jpg', name: 'Industrial HMI Panel 15 inch', brand: 'Siemens', sku: 'TP1500-Comfort', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-040', filename: 'product-040.jpg', name: 'Temperature Controller PID', brand: 'Honeywell', sku: 'DC1040-PT100', category: 'electrical', industry: ['chemical-processing', 'manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-041', filename: 'product-041.jpg', name: 'Modular PLC I/O Module', brand: 'Siemens', sku: '6ES7131-6BH00', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-042', filename: 'product-042.jpg', name: 'DIN Rail Power Supply 24V', brand: 'Phoenix Contact', sku: 'QUINT4-PS', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-043', filename: 'product-043.jpg', name: 'Industrial Ethernet Switch', brand: 'Siemens', sku: 'SCALANCE-XC206', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-044', filename: 'product-044.jpg', name: 'Contactron Motor Starter', brand: 'Phoenix Contact', sku: 'EFFICIENT-250', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-045', filename: 'product-045.jpg', name: 'Servo Drive Unit 3kW', brand: 'Bosch Rexroth', sku: 'SEV-3000-BR', category: 'electrical', industry: ['manufacturing'], availability: 'emergency', specs: {} },
  { id: 'prod-046', filename: 'product-046.jpg', name: 'Molded Case Circuit Breaker', brand: 'ABB', sku: 'Tmax-XT2-250', category: 'electrical', industry: ['power-generation'], availability: 'in-stock', specs: {} },
  { id: 'prod-047', filename: 'product-047.jpg', name: 'Digital Power Meter', brand: 'Schneider Electric', sku: 'PM8000-series', category: 'electrical', industry: ['power-generation'], availability: 'in-stock', specs: {} },
  { id: 'prod-048', filename: 'product-048.jpg', name: 'Variable Frequency Drive 15kW', brand: 'Danfoss', sku: 'FC-102P1K5T4', category: 'electrical', industry: ['manufacturing'], availability: 'emergency', specs: {} },
  { id: 'prod-049', filename: 'product-049.jpg', name: 'Safety Relay Module', brand: 'Pilz', sku: 'PNOZ-X3-24VDC', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-050', filename: 'product-050.jpg', name: 'Panel Mount Ammeter', brand: 'Honeywell', sku: 'DAK-6000-AMP', category: 'electrical', industry: ['power-generation'], availability: 'in-stock', specs: {} },
  { id: 'prod-051', filename: 'product-051.jpg', name: 'Industrial Relay Module 8CH', brand: 'Omron', sku: 'G2R-1-SN-24VDC', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-052', filename: 'product-052.jpg', name: 'Thermal Overload Relay', brand: 'Schneider Electric', sku: 'LRD3363C', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-053', filename: 'product-053.jpg', name: 'AC Drive Module 55kW', brand: 'Siemens', sku: 'G120C-PM250', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-054', filename: 'product-054.jpg', name: 'Smart MCC Panel Section', brand: 'ABB', sku: 'MNS-iS-4000', category: 'electrical', industry: ['manufacturing', 'power-generation'], availability: 'in-stock', specs: {} },
  { id: 'prod-055', filename: 'product-055.jpg', name: 'Surge Protection Device Type2', brand: 'Phoenix Contact', sku: 'VALVETRAB-275', category: 'electrical', industry: ['power-generation'], availability: 'in-stock', specs: {} },
  { id: 'prod-056', filename: 'product-056.jpg', name: 'Industrial UPS 3kVA', brand: 'Emerson', sku: 'APC-SMT3000', category: 'electrical', industry: ['manufacturing', 'power-generation'], availability: 'in-stock', specs: {} },
  { id: 'prod-057', filename: 'product-057.jpg', name: 'Motor Soft Starter 132kW', brand: 'Siemens', sku: '3RT2036-2AK60', category: 'electrical', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-058', filename: 'product-058.jpg', name: 'Capacitor Bank 50kVAR', brand: 'ABB', sku: 'CLMD-50-AB', category: 'electrical', industry: ['power-generation'], availability: 'in-stock', specs: {} },

  // HYDRAULIC SYSTEMS (25)
  { id: 'prod-059', filename: 'product-059.jpg', name: 'Axial Piston Pump 75cc', brand: 'Bosch Rexroth', sku: 'A10VSO-71-DFR1', category: 'hydraulic', industry: ['marine-shipping', 'oil-gas'], availability: 'in-stock', specs: {} },
  { id: 'prod-060', filename: 'product-060.jpg', name: 'Hydraulic Cylinder 100mm Bore', brand: 'Parker', sku: 'HCR-100-500-PK', category: 'hydraulic', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', specs: {} },
  { id: 'prod-061', filename: 'product-061.jpg', name: 'Directional Control Valve', brand: 'Bosch Rexroth', sku: '4WE6-E70-31', category: 'hydraulic', industry: ['manufacturing', 'oil-gas'], availability: 'in-stock', specs: {} },
  { id: 'prod-062', filename: 'product-062.jpg', name: 'Hydraulic Power Unit 15kW', brand: 'Parker', sku: 'HPU-15000-PK', category: 'hydraulic', industry: ['oil-gas', 'marine-shipping'], availability: 'emergency', specs: {} },
  { id: 'prod-063', filename: 'product-063.jpg', name: 'Gear Pump 40cc', brand: 'Bosch Rexroth', sku: 'CBN-F3040', category: 'hydraulic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-064', filename: 'product-064.jpg', name: 'Hydraulic Filter Element 10um', brand: 'Parker', sku: 'HC9600FKS13H', category: 'hydraulic', industry: ['oil-gas'], availability: 'in-stock', specs: {} },
  { id: 'prod-065', filename: 'product-065.jpg', name: 'Proportional Pressure Valve', brand: 'Bosch Rexroth', sku: 'DBE-6X-G24', category: 'hydraulic', industry: ['oil-gas'], availability: 'in-stock', specs: {} },
  { id: 'prod-066', filename: 'product-066.jpg', name: 'Hydraulic Accumulator 4L', brand: 'Parker', sku: 'PRM-4000-PK', category: 'hydraulic', industry: ['marine-shipping'], availability: 'in-stock', specs: {} },
  { id: 'prod-067', filename: 'product-067.jpg', name: 'Vane Pump 25cc', brand: 'Parker', sku: 'T6DC-028-010', category: 'hydraulic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-068', filename: 'product-068.jpg', name: 'Counterbalance Valve', brand: 'Bosch Rexroth', sku: 'DZ10DP2-5X', category: 'hydraulic', industry: ['oil-gas'], availability: 'in-stock', specs: {} },
  { id: 'prod-069', filename: 'product-069.jpg', name: 'Hydraulic Hose Assembly 1m', brand: 'Parker', sku: '2SN-25-1000', category: 'hydraulic', industry: ['shipyards'], availability: 'in-stock', specs: {} },
  { id: 'prod-070', filename: 'product-070.jpg', name: 'Flow Control Valve', brand: 'Bosch Rexroth', sku: '2FRM-16-31', category: 'hydraulic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-071', filename: 'product-071.jpg', name: 'Hydraulic Motor 500cc/rev', brand: 'Danfoss', sku: 'OMR-500-DF', category: 'hydraulic', industry: ['marine-shipping'], availability: 'in-stock', specs: {} },
  { id: 'prod-072', filename: 'product-072.jpg', name: 'Pressure Relief Valve 250bar', brand: 'Parker', sku: 'DBDS-6-P1/315', category: 'hydraulic', industry: ['oil-gas'], availability: 'in-stock', specs: {} },
  { id: 'prod-073', filename: 'product-073.jpg', name: 'Hydraulic Tank 200L', brand: 'Bosch Rexroth', sku: 'TK-200-BR', category: 'hydraulic', industry: ['shipyards'], availability: 'in-stock', specs: {} },
  { id: 'prod-074', filename: 'product-074.jpg', name: 'Hydraulic Manifold Block 6-Port', brand: 'Parker', sku: 'HMB-06-PK', category: 'hydraulic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-075', filename: 'product-075.jpg', name: 'Check Valve Pilot Operated', brand: 'Bosch Rexroth', sku: 'SL10PA2-5X', category: 'hydraulic', industry: ['oil-gas'], availability: 'in-stock', specs: {} },
  { id: 'prod-076', filename: 'product-076.jpg', name: 'Hydraulic Cartridge Valve', brand: 'Parker', sku: 'CD08-30-PK', category: 'hydraulic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-077', filename: 'product-077.jpg', name: 'Solenoid Valve 24VDC 3/2', brand: 'Bosch Rexroth', sku: '4WE5-C6X', category: 'hydraulic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-078', filename: 'product-078.jpg', name: 'Hydraulic Quick Coupling Set', brand: 'Parker', sku: 'Palmprint-60', category: 'hydraulic', industry: ['shipyards'], availability: 'in-stock', specs: {} },
  { id: 'prod-079', filename: 'product-079.jpg', name: 'Radial Piston Pump 100cc', brand: 'Bosch Rexroth', sku: 'RP100-BR-31', category: 'hydraulic', industry: ['oil-gas'], availability: 'in-stock', specs: {} },
  { id: 'prod-080', filename: 'product-080.jpg', name: 'Hydraulic Oil Cooler 5kW', brand: 'Danfoss', sku: 'SK1-055-KK', category: 'hydraulic', industry: ['power-generation'], availability: 'in-stock', specs: {} },
  { id: 'prod-081', filename: 'product-081.jpg', name: 'Proportional Flow Valve', brand: 'Bosch Rexroth', sku: '4WRPE-6-CB2', category: 'hydraulic', industry: ['oil-gas'], availability: 'in-stock', specs: {} },
  { id: 'prod-082', filename: 'product-082.jpg', name: 'Hydraulic Test Gauge 400bar', brand: 'Parker', sku: 'TG-400-PK', category: 'hydraulic', industry: ['shipyards'], availability: 'in-stock', specs: {} },
  { id: 'prod-083', filename: 'product-083.jpg', name: 'Hydraulic Power Pack 5.5kW', brand: 'Parker', sku: 'HPU-5500-PK', category: 'hydraulic', industry: ['marine-shipping'], availability: 'emergency', specs: {} },

  // PNEUMATIC SYSTEMS (22)
  { id: 'prod-084', filename: 'product-084.jpg', name: 'Pneumatic Cylinder ISO 15552', brand: 'Festo', sku: 'DSBC-63-200-PPVA', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-085', filename: 'product-085.jpg', name: 'Air Solenoid Valve 5/2', brand: 'SMC', sku: 'VFA5220-03', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-086', filename: 'product-086.jpg', name: 'FRL Unit with Gauge', brand: 'Festo', sku: 'MSB6-1Z', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-087', filename: 'product-087.jpg', name: 'Pneumatic Gripper Parallel', brand: 'SMC', sku: 'MHZ2-20D', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-088', filename: 'product-088.jpg', name: 'Air Dryer Regenerative', brand: 'Atlas Copco', sku: 'FD-410', category: 'pneumatic', industry: ['manufacturing', 'chemical-processing'], availability: 'in-stock', specs: {} },
  { id: 'prod-089', filename: 'product-089.jpg', name: 'Pneumatic Rotary Actuator', brand: 'Festo', sku: 'DRQD-25-90', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-090', filename: 'product-090.jpg', name: 'Quick Exhaust Valve', brand: 'SMC', sku: 'AQ2000-02', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-091', filename: 'product-091.jpg', name: 'Pneumatic Air Gun', brand: 'Festo', sku: 'MGP-40-AR', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-092', filename: 'product-092.jpg', name: 'Air Preparation Unit Mini', brand: 'SMC', sku: 'AC30-03-A', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-093', filename: 'product-093.jpg', name: 'Pneumatic Tubing 8mm Blue', brand: 'SMC', sku: 'TUB-8-BLU', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-094', filename: 'product-094.jpg', name: 'Flow Sensor Pneumatic', brand: 'Festo', sku: 'SFAB-10-10-1SA', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-095', filename: 'product-095.jpg', name: 'Vacuum Generator Multi Stage', brand: 'SMC', sku: 'ZU10-06-60', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-096', filename: 'product-096.jpg', name: 'Pneumatic Silencer Muffler', brand: 'SMC', sku: 'AN20-02-A', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-097', filename: 'product-097.jpg', name: 'Rodless Cylinder Guided', brand: 'Festo', sku: 'MFY-30-250', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-098', filename: 'product-098.jpg', name: 'Pneumatic Push-In Fitting Set', brand: 'SMC', sku: 'KQ2L-08-06A', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-099', filename: 'product-099.jpg', name: 'Air Receiver Tank 100L', brand: 'Atlas Copco', sku: 'ART-100-AC', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
  { id: 'prod-100', filename: 'product-100.jpg', name: 'Pneumatic Timer Valve', brand: 'Festo', sku: 'VHEF-MS-L-1/8', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', specs: {} },
