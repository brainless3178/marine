...
async function main() {
  ...
  const productData = [
    { name: 'Marine GPS Navigator', brand: 'ABB', sku: 'GPS-NAV-3200', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', price: 3200, filename: 'product-001.jpg' },
    { name: 'Deck Crane Hydraulic Motor', brand: 'Parker', sku: 'DCM-450-PK', category: 'marine', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', price: 4500, filename: 'product-002.jpg' },
    { name: 'VHF Marine Radio', brand: 'Siemens', sku: 'VHF-7800-SM', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', price: 1800, filename: 'product-003.jpg' },
    { name: 'Radar Antenna Unit', brand: 'Honeywell', sku: 'RAD-ANT-220', category: 'marine', industry: ['marine-shipping'], availability: 'in-stock', price: 5600, filename: 'product-004.jpg' },
    { name: 'ECDIS Navigation Display', brand: 'ABB', sku: 'ECDIS-9600', category: 'marine', industry: ['marine-shipping'], availability: 'emergency', price: 8900, filename: 'product-005.jpg' },
    { name: 'Variable Speed Drive 2.2kW', brand: 'ABB', sku: 'ACS880-01-02A7', category: 'electrical', industry: ['manufacturing', 'power-generation'], availability: 'emergency', price: 2200, filename: 'product-031.jpg' },
    { name: 'PLC CPU Module S7-1500', brand: 'Siemens', sku: '6ES7511-1AK02', category: 'electrical', industry: ['manufacturing'], availability: 'emergency', price: 4500, filename: 'product-032.jpg' },
    { name: 'Contactor 40A 3-Pole', brand: 'Schneider Electric', sku: 'LC1D40M7C', category: 'electrical', industry: ['manufacturing', 'power-generation'], availability: 'in-stock', price: 320, filename: 'product-033.jpg' },
    { name: 'Axial Piston Pump 75cc', brand: 'Bosch Rexroth', sku: 'A10VSO-71-DFR1', category: 'hydraulic', industry: ['marine-shipping', 'oil-gas'], availability: 'in-stock', price: 3800, filename: 'product-059.jpg' },
    { name: 'Hydraulic Cylinder 100mm Bore', brand: 'Parker', sku: 'HCR-100-500-PK', category: 'hydraulic', industry: ['marine-shipping', 'shipyards'], availability: 'in-stock', price: 1200, filename: 'product-060.jpg' },
    { name: 'Pneumatic Cylinder ISO 15552', brand: 'Festo', sku: 'DSBC-63-200-PPVA', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', price: 450, filename: 'product-084.jpg' },
    { name: 'Air Solenoid Valve 5/2', brand: 'SMC', sku: 'VFA5220-03', category: 'pneumatic', industry: ['manufacturing'], availability: 'in-stock', price: 180, filename: 'product-085.jpg' },
